...
from submit.amlt_utils.setup_amlt import check_secrets, prepare_secrets       # noqa: E402
from submit.zetta_utils.region_manager import get_region_by_workspace         # noqa: E402
from submit.zetta_utils.region_manager import get_premium_storage_by_region   # noqa: E402
from submit.zetta_utils.region_manager import get_standard_storage_by_region  # noqa: E402
...
def main():
    ...
    # Load config
    # ------------------------------------------------------------------------
    with open(ZettAConfigFile, "w", encoding="utf-8") as f:
    ...
    standard_datastore_name = "stdstoragettsdp01eus_data"
    ...
    premium_datastore_name = "stdstoragettsdp01eus_data"
    ...
    with open(ZettARunnerFile, "w", encoding="utf-8") as f:
        f.write("#!/bin/bash\n")

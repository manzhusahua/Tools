...
class STEP1():
    ...
    def step1_getaudioList(self,inputdir,locals):
        token = r'?sv=2023-01-03&ss=btqf&srt=sco&st=2024-04-19T02%3A51%3A37Z&se=2024-04-20T02%3A51%3A37Z&sp=rwdxftlacup&sig=ul1K0IUhN7psToYKH15JPKYcQEiSS6iiPb0oVChKZzY%3D'
